...
landmark_info = {
    ...
    "Alula Fort":                ("images/Alula_Fort.jpg",                 "Perched above the valley, this 9th‑century stone fortress protected caravans on the incense route. Its raised walls, towers and vaulted chambers command sweeping views. Archaeologists believe it served both military and administrative functions."),
    ...
    "Maraya Concert Hall":       ("images/Maraya_Concert_Hall.webp",        "A world‑record mirror‑clad structure reflecting the valley. Its LED‑lined interior hosts concerts and festivals."),
